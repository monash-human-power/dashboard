...
function startPowerModel() {
    ...
    document.getElementById('status-success-message').innerHTML = 'Started power model!';
}
...
function stopPowerModel() {
    ...
    document.getElementById('status-success').style.display = 'block';
    document.getElementById('status-success-message').innerHTML = 'Stopping power model!';
}
