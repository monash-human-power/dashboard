...
import LocationMap, { LocationTimeSeriesPoint } from 'components/common/charts/LocationMap';
...
export default function V3LocationMap(): JSX.Element {
    const [locationHistory, setLocationHistory] = useState<LocationTimeSeriesPoint[]>([]);
    ...
    useEffect(() => {
        if (GPS) {
            ...
            if (isValidLocation(location)) setLocationHistory([...locationHistory, location]);
        };
