...
import OverlaySelection, {
  OverlaySelectionProps,
} from 'components/common/camera_settings/OverlaySelection';

export default {
  component: OverlaySelection,
  title: 'components/common/camera_settings/OverlaySelection',
};

const Template = addArgs<OverlaySelectionProps>((props) => (
  <OverlaySelection {...props} />
));
